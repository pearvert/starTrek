...
//  .style("stroke-width", makeRingVisible)
;
...
// Should be changed from d.makeRingVisible to whatever the data set uses.
function makeRingVisible(d) {
  if (d.makeRingVisible == "1") {return .75;}
    else {return 0;}
}
